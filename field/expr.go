...
func (e expr) add(value interface{}) expr {
	...
	case decimal.Decimal:
		return e.setE(clause.Expr{SQL: "?+convert(?,decimal(36,18))", Vars: []interface{}{e.RawExpr(), v}})
	default:
...
func (e expr) mul(value interface{}) expr {
	if e.isPure() {
		switch v := value.(type) {
		case decimal.Decimal:
			return e.setE(clause.Expr{SQL: "?*convert(?,decimal(36,18))", Vars: []interface{}{e.col, v}})
		default:
	...
	switch v := value.(type) {
	case decimal.Decimal:
		return e.setE(clause.Expr{SQL: "(?)*convert(?,decimal(36,18))", Vars: []interface{}{e.e, v}})
	default:
