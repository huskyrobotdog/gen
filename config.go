...
type Config struct {
	...
	dataTypeMap    map[string]func(tableName string, fieldName string, columnType gorm.ColumnType) (dataType string)
	fieldJSONTagNS func(fieldType string, columnName string) (tagContent string)
...
func (cfg *Config) WithDataTypeMap(newMap map[string]func(tableName string, fieldName string, columnType gorm.ColumnType) (dataType string)) {
	cfg.dataTypeMap = newMap
}

// WithJSONTagNameStrategy specify json tag naming strategy
func (cfg *Config) WithJSONTagNameStrategy(ns func(fieldType string, columnName string) (tagContent string)) {
